...
echo.
echo *****************************************************************************
echo * HYDRA-UMC-EDITOR-STL - build.bat
...
REM Builds HYDRA-UMC-EDITOR-STL: creates/activates a venv, installs the project
...
python -m py_compile src\hydra_umc_editor_stl\__init__.py src\hydra_umc_editor_stl\model_catalog.py src\hydra_umc_editor_stl\stl_ops.py src\hydra_umc_editor_stl\settings.py src\hydra_umc_editor_stl\i18n.py src\hydra_umc_editor_stl\main.py src\hydra_umc_editor_stl\qt_gui.py
if errorlevel 1 goto :error
python -c "import hydra_umc_editor_stl; print('import OK - version', hydra_umc_editor_stl.__version__)"
if errorlevel 1 goto :error
echo       Done.
echo.
