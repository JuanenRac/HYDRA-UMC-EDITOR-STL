...
REM *****************************************************************************
REM Project   : HYDRA-UMC-EDITOR-STL
REM Script    : run.bat
...
echo.
echo *****************************************************************************
echo * HYDRA-UMC-EDITOR-STL - run.bat
...
REM Runs HYDRA-UMC-EDITOR-STL. Run build.bat first.
REM
REM Usage:
REM   run.bat                                          - launch the windowed GUI (default)
REM   run.bat --cli categories studio                  - list categories in a library
REM   run.bat --cli models studio robots-6-dof         - list models in a category
REM   run.bat --cli parts studio robots-6-dof ar3       - list a model's real part files
REM   run.bat --cli transform studio robots-6-dof ar3 base_link.STL --tz 10
REM   run.bat --cli replace studio robots-6-dof ar3 base_link.STL C:\path\new.stl
REM   run.bat --cli remove studio robots-6-dof ar3 base_link.STL
REM   run.bat --cli add studio robots-6-dof ar3 C:\path\new.stl
cd /d "%~dp0"

if exist .venv\Scripts\python.exe (
    .venv\Scripts\python.exe -m hydra_umc_editor_stl.main %*
) else (
