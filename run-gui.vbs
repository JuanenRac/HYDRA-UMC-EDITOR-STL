' =============================================================================
' HYDRA-UMC-EDITOR-STL - Silent Qt Quick desktop launcher: run-gui.vbs
...
If Not fileSystem.FileExists(pythonw) Then
    shell.Popup "HYDRA-UMC-EDITOR-STL needs its GUI runtime first. Run build.bat once, then launch run-gui.vbs.", 0, "HYDRA-UMC-EDITOR-STL", 48
    WScript.Quit 1
End If

command = Chr(34) & pythonw & Chr(34) & " -m hydra_umc_editor_stl.main"
